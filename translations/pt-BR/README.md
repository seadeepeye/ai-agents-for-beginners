...
![Generative AI For Beginners](../../translated_images/pt-BR/repo-thumbnailv2.06f4a48036fde647.webp)

## Um curso que ensina tudo que você precisa saber para começar a construir Agentes de IA
...
>
> Este repositório inclui traduções em mais de 50 idiomas, aumentando significativamente o tamanho do download. Para clonar sem traduções, use checkout esparso:
>
> **Bash / macOS / Linux:**
> ```bash
...
Este curso possui lições cobrindo os fundamentos para construir Agentes de IA. Cada lição trata de seu próprio tema, então comece onde quiser!

Há suporte multi-idioma para este curso. Veja nossas [linguagens disponíveis aqui](#-multi-language-support).
...
Não esqueça de [favoritar (🌟) este repositório](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e [fazer um fork deste repositório](https://github.com/microsoft/ai-agents-for-beginners/fork) para executar o código.

### Conheça Outros Estudantes, Tire Suas Dúvidas

Se você ficar preso ou tiver dúvidas sobre construir Agentes de IA, junte-se ao nosso canal dedicado no Discord em [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Para mais informações sobre como rodar o código deste curso, acesse a [Configuração do Curso](./00-course-setup/README.md).
...
- Exemplos de código em Python usando Microsoft Agent Framework com Azure AI Foundry
...
| Entendendo Padrões de Design em Agentes de IA | [Link](./03-agentic-design-patterns/README.md)     | [Vídeo](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Padrão de Design Metacognição                 | [Link](./09-metacognition/README.md)               | [Vídeo](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Usando Protocolos Agentes (MCP, A2A e NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Vídeo](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Gerenciando Memória Agente                      | [Link](./13-agent-memory/README.md)     |      [Vídeo](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Explorando o Microsoft Agent Framework                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Construindo Agentes de Uso de Computador (CUA)           | Em Breve                            |                                                            |                                                                                        |
...
Obrigado a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) por contribuir com importantes exemplos de código demonstrando Agentic RAG.
...
os direitos para usar sua contribuição. Para detalhes, visite <https://cla.opensource.microsoft.com>.

Quando você envia um pull request, um bot CLA determinará automaticamente se você precisa fornecer
...
contate [opencode@microsoft.com](mailto:opencode@microsoft.com) para quaisquer perguntas ou comentários adicionais.

## Marcas Registradas

Este projeto pode conter marcas registradas ou logos de projetos, produtos ou serviços. O uso autorizado das marcas ou logos da Microsoft
está sujeito a e deve seguir as
[Diretrizes de Marcas e Marca Registrada da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
O uso das marcas ou logos da Microsoft em versões modificadas deste projeto não deve causar confusão nem indicar patrocínio da Microsoft.
Qualquer uso de marcas ou logos de terceiros está sujeito às políticas desses terceiros.

## Obtendo Ajuda


Se você ficar travado ou tiver dúvidas sobre como construir aplicativos de IA, participe:

[![Microsoft Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

Se você tiver feedback sobre produtos ou encontrar erros durante a construção, visite:
