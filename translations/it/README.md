...
![AI Generativa per Principianti](../../translated_images/it/repo-thumbnailv2.06f4a48036fde647.webp)
...
[![Collaboratori GitHub](https://img.shields.io/github/contributors/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
[![Issue GitHub](https://img.shields.io/github/issues/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/issues/?WT.mc_id=academic-105485-koreyst)
...
[![PRs Benvenuti](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
>
> Questo repository include traduzioni in oltre 50 lingue che aumentano significativamente la dimensione del download. Per clonare senza le traduzioni, usa il checkout sparso:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Se desideri avere supporto per ulteriori lingue di traduzione, sono elencate [qui](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Questo corso contiene lezioni che coprono le basi della costruzione di Agenti AI. Ogni lezione tratta un argomento specifico, quindi puoi iniziare da dove vuoi!

Il corso supporta più lingue. Vai alle [lingue disponibili qui](#-multi-language-support).

Se è la prima volta che costruisci con modelli di AI Generativa, dai un'occhiata al nostro corso [AI Generativa per Principianti](https://aka.ms/genai-beginners), che include 21 lezioni sulla costruzione con GenAI.

Non dimenticare di [mettere una stella (🌟) a questo repository](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) e di [fare fork di questo repository](https://github.com/microsoft/ai-agents-for-beginners/fork) per eseguire il codice.

### Incontra altri studenti, ottieni risposte alle tue domande

Se sei bloccato o hai domande sulla costruzione di Agenti AI, unisciti al nostro canale Discord dedicato nel [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Cosa ti serve

Ogni lezione in questo corso include esempi di codice, che si trovano nella cartella code_samples. Puoi [fare fork di questo repository](https://github.com/microsoft/ai-agents-for-beginners/fork) per creare una tua copia.
...
Per maggiori informazioni su come eseguire il codice di questo corso, vai a [Setup del corso](./00-course-setup/README.md).
...
- Una lezione scritta nel README e un video breve
- Esempi di codice Python usando Microsoft Agent Framework con Azure AI Foundry
- Link a risorse extra per continuare ad apprendere
...
| Esplorare i Framework Agentici                | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
Grazie a [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) per aver contribuito con importanti esempi di codice che mostrano Agentic RAG.

## Contributi

Questo progetto accoglie contributi e suggerimenti. La maggior parte dei contributi richiede che tu accetti un
Accordo di Licenza del Contributore (CLA) che dichiari di avere il diritto e di concedere effettivamente a noi
...
una CLA e decorerà la PR di conseguenza (ad esempio, controllo stato, commento). Segui semplicemente le istruzioni
fornite dal bot. Dovrai farlo solo una volta per tutti i repository che utilizzano la nostra CLA.
...
Per maggiori informazioni, consulta le [FAQ del Codice di Condotta](https://opensource.microsoft.com/codeofconduct/faq/) oppure
contatta [opencode@microsoft.com](mailto:opencode@microsoft.com) per qualsiasi domanda o commento aggiuntivo.

## Marchi

Questo progetto può contenere marchi o loghi di progetti, prodotti o servizi. L'uso autorizzato dei marchi
o loghi Microsoft è soggetto a e deve seguire
[Linee guida Microsoft per Marchi e Brand](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
