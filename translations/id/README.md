...
![Generative AI For Beginners](../../translated_images/id/repo-thumbnailv2.06f4a48036fde647.webp)
...
**Jika Anda ingin mendukung bahasa terjemahan tambahan yang tersedia, daftarnya ada [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
### Bertemu dengan Pelajar Lain, Dapatkan Jawaban untuk Pertanyaan Anda
...
Setiap pelajaran dalam kursus ini mencakup contoh kode, yang dapat ditemukan di folder code_samples. Anda dapat [fork repo ini](https://github.com/microsoft/ai-agents-for-beginners/fork) untuk membuat salinan sendiri.
...
Untuk informasi lebih lanjut tentang menjalankan kode untuk kursus ini, silakan lihat di [Course Setup](./00-course-setup/README.md).
...
- Sebuah pelajaran tertulis yang terletak di README dan video singkat
...
| Menjelajahi Kerangka Agentic AI              | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)   | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Memahami Pola Desain Agentic AI               | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)   | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Menjelajahi Kerangka Kerja Microsoft Agent                         | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
Tim kami menghasilkan kursus lainnya! Cek:
...
Ketika Anda mengirimkan pull request, bot CLA secara otomatis akan menentukan apakah Anda perlu memberikan
CLA dan menghias PR dengan tepat (misalnya, pemeriksaan status, komentar). Cukup ikuti instruksi
yang diberikan oleh bot. Anda hanya perlu melakukan ini sekali untuk semua repo yang menggunakan CLA kami.
...
Jika Anda mengalami kesulitan atau memiliki pertanyaan seputar pembangunan aplikasi AI, bergabunglah dengan:
