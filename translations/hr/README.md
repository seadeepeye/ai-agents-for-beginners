...
![Generative AI For Beginners](../../translated_images/hr/repo-thumbnailv2.06f4a48036fde647.webp)

## Tečaj koji uči sve što trebate znati za početak gradnje AI Agenata
...
> ```
>
> To vam daje sve što trebate za dovršetak tečaja s mnogo bržim preuzimanjem.
...
Ovaj tečaj ima lekcije koje pokrivaju osnove izgradnje AI Agenata. Svaka lekcija pokriva svoju temu pa započnite gdje god želite!

Za ovaj tečaj postoji podrška za više jezika. Pogledajte naše [dostupne jezike ovdje](#-multi-language-support).

Ako vam je ovo prvi put da radite s Generativnim AI modelima, pogledajte naš tečaj [Generative AI For Beginners](https://aka.ms/genai-beginners), koji uključuje 21 lekciju o radu s GenAI.
...
Ako zapnete ili imate bilo kakvih pitanja o izgradnji AI Agenata, pridružite se našem namjenskom Discord kanalu u [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Što vam je potrebno

Svaka lekcija u ovom tečaju uključuje primjere koda, koji se mogu pronaći u mapi code_samples. Možete [forkati ovaj repozitorij](https://github.com/microsoft/ai-agents-for-beginners/fork) da napravite vlastitu kopiju.
...
Imate li prijedloge ili ste pronašli pravopisne ili kodne pogreške? [Otvorite issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) ili [Napravite pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)



## 📂 Svaka lekcija uključuje

- Napisanu lekciju u README datoteci i kratki video
- Primjere Python koda koristeći Microsoft Agent Framework s Azure AI Foundry
...
|----------------------------------------------|----------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Uvod u AI Agente i primjere korištenja agenata | [Link](./01-intro-to-ai-agents/README.md)          | [Video](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Istraživanje AI Agent okvira                  | [Link](./02-explore-agentic-frameworks/README.md)  | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Razumijevanje dizajnerskih obrazaca AI agenata | [Link](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Dizajnerski obrazac planiranja                 | [Link](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Dizajnerski obrazac više agenata                | [Link](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Metakognitivni dizajnerski uzorak              | [Link](./09-metacognition/README.md)               | [Video](https://youtu.be/His9R6gw6Ec?si=8gck6vvdSNCt6OcF)  | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Korištenje agentskih protokola (MCP, A2A i NLWeb) | [Link](./11-agentic-protocols/README.md)           | [Video](https://youtu.be/X-Dh9R3Opn8)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Inženjerstvo konteksta za AI agente           | [Link](./12-context-engineering/README.md)         | [Video](https://youtu.be/F5zqRV7gEag)                                 | [Link](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Upravljanje agentskom memorijom                | [Link](./13-agent-memory/README.md)     |      [Video](https://youtu.be/QrYbHesIxpw?si=vZkVwKrQ4ieCcIPx)                                                      |                                                                                        |
| Istraživanje Microsoft Agent Frameworka       | [Link](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Izrada agenata za korištenje računala (CUA)   | Uskoro dostupno                            |                                                            |                                                                                        |
...
Zahvaljujemo [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) na doprinosu važnih primjera koda koji pokazuju Agentic RAG.

## Doprinos

Ovaj projekt pozdravlja doprinose i prijedloge. Većina doprinosa zahtijeva da pristanete na
Ugovor o licenci za suradnika (CLA) u kojem izjavljujete da imate pravo i da doista dajete
...
koje vam bot pruži. Ovo ćete morati napraviti samo jednom za sve repozitorije koji koriste naš CLA.

Ovaj projekt je usvojio [Microsoftov Kodeks ponašanja za otvoreni izvor](https://opensource.microsoft.com/codeofconduct/).
Više informacija potražite u [FAQ o kodeksu ponašanja](https://opensource.microsoft.com/codeofconduct/faq/) ili
